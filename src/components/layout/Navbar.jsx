...
import { Menu, X, Bell, User, Sun, Moon, Search } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';
import { useTheme, useAuth } from '../../contexts';
import { Button, Avatar, SearchBar } from '../common';
...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-40 glass border-b border-gray-200/50 dark:border-dark-border/50">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden md:block">
              <Link
                to="/search"
                className="p-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-dark-card rounded-lg transition-colors inline-block"
              >
            ...
            <button
              onClick={toggleTheme}
              className="p-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-dark-card rounded-lg transition-colors"
            ...
            {/* Notifications */}
            {isAuthenticated && (
              <button className="relative p-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-dark-card rounded-lg transition-colors">
